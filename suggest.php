...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)){
        ...
        $mail->Username = "corey.j.russ@gmail.com";
        //Password to use for SMTP authentication
        //Password removed in this code version
        $mail->Password = "#########";
        //It's important not to use the submitter's address as the from address as it's forgery,
        //which will cause your messages to fail SPF checks.
        //Use an address in your own domain as the from address, put the submitter's address in a reply-to
        $mail->setFrom('corey.j.russ@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('corey.j.russ@gmail.com', 'Corey Russ');
    ...
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            ...
            if (isset($error_message)) {
                ...
                echo "<p>If you think there is something I'm missing, let me know! Complete the form 
                ...
                <tr>
                    ...
                    <td><select id="category" name="category">
                        ...
                        <option value="Music"<?php 
                            if(isset($category) && $category == "Music") echo 
                            " selected";
                        ?>>Music</option>
                    </select></td>
                </tr>
